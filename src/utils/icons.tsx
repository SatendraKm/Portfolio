...
import LeetCodeLogo from "../assets/icons/leetcode.webp";
...
const LeetCodeIcon: FC<ImgHTMLAttributes<HTMLImageElement>> = ({
  alt = "LeetCode",
  ...props
}) => {
  const src =
    typeof LeetCodeLogo === "string" ? LeetCodeLogo : LeetCodeLogo.src;

  return <img src={src} alt={alt} width={24} height={24} {...props} />;
};
